    ...
    <main>
      ...
      <div className='flex flex-col bg-primary min-h-screen'>
          ...
          <div className='ml-10 lg:ml-36 mt-20 space-y-4'>
            ...
            <h1 className='hidden font-space  text-[64px] pb-4 font-bold md:block'>Mozart quote lol</h1>
            <h1 className='font-space text-[40px] pb-4 md:hidden'>Mozart Quote lol</h1>
