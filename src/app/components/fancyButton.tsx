...
export default function FancyButton(props: any) {
  return (
    <Link href={props.href} className=" hidden hover:underline md:block">
      ...
      >
        <span className="hover:slac rounded-[11px] bg-gradient-to-b from-[#4DDFC2] to-[#04D2A9] p-px md:inline-block">
          <span className="text-bold items-center gap-x-1.5 rounded-[10px] bg-[#04D2A9] px-2 py-1 text-sm text-white md:inline-flex">
            {props.text}
