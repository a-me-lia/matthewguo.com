    ...
    <main>
      <div className="mx-auto min-h-screen font-sans">
        <div className="flex min-h-screen flex-col bg-primary text-white">
          ...
          <div className="mt-36 h-min rounded-t-[80px] bg-gradient-to-b from-darkbg via-darkbg via-60% to-transparent drop-shadow-[0_-200px_200px_rgba(255,255,255,0.04)] md:mt-40 lg:rounded-t-[160px]">
